---
title: "adoresever/graph-memory: Openclaw记忆插件Knowledge Graph + Memory；Knowledge Graph Context Engine for OpenClaw — extracts structured triples from conversations, compresses context 75%, enables cross-session experience reuse"
source: "https://github.com/adoresever/graph-memory"
author:
published:
created: 2026-04-04
description: "Openclaw记忆插件Knowledge Graph + Memory；Knowledge Graph Context Engine for OpenClaw — extracts structured triples from conversations, compresses context 75%, enables cross-session experience reuse - adoresever/graph-memory"
tags:
  - "clippings"
---
[![graph-memory](https://github.com/adoresever/graph-memory/raw/main/docs/images/banner.jpg)](https://github.com/adoresever/graph-memory/blob/main/docs/images/banner.jpg)

## graph-memory

**Knowledge Graph Context Engine for OpenClaw**  
By [adoresever](mailto:Wywelljob@gmail.com) · MIT License

[Installation](#installation) · [How it works](#how-it-works) · [Configuration](#configuration) · [中文文档](https://github.com/adoresever/graph-memory/blob/main/README_CN.md)

---

[![graph-memory overview](https://github.com/adoresever/graph-memory/raw/main/docs/images/hero.png)](https://github.com/adoresever/graph-memory/blob/main/docs/images/hero.png)
...
[![graph-memory knowledge graph visualization with community detection](https://github.com/adoresever/graph-memory/raw/main/docs/images/graph-ui.png)](https://github.com/adoresever/graph-memory/blob/main/docs/images/graph-ui.png)
...
[![Token comparison: 7 rounds](https://github.com/adoresever/graph-memory/raw/main/docs/images/token-comparison.png)](https://github.com/adoresever/graph-memory/blob/main/docs/images/token-comparison.png)
...
[![Cross-session recall](https://github.com/adoresever/graph-memory/raw/main/docs/images/token-sessions.png)](https://github.com/adoresever/graph-memory/blob/main/docs/images/token-sessions.png)
...
| No `extracted` log after `afterTurn` | Gateway restart caused turn\_index overlap | Update to v2.0 (fixes msgSeq persistence) |
...
| Table | Purpose |
| --- | --- |
| `gm_nodes` | Knowledge nodes with pagerank + community\_id |
