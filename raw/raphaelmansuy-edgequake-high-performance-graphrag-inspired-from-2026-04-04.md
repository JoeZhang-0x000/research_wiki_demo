---
title: "raphaelmansuy/edgequake: High-performance GraphRAG inspired from LightRag written in Rust"
source: "https://github.com/raphaelmansuy/edgequake"
author:
published:
created: 2026-04-04
description: "High-performance GraphRAG inspired from LightRag written in Rust - raphaelmansuy/edgequake"
tags:
  - "clippings"
---
## EdgeQuake

[![raphaelmansuy%2Fedgequake | Trendshift](https://camo.githubusercontent.com/65dd36abd7e793b4add33687604d4299ca0d7d6c507eafc6708b631ddc2db48c/68747470733a2f2f7472656e6473686966742e696f2f6170692f62616467652f7265706f7369746f726965732f3230383933)](https://trendshift.io/repositories/20893)
...
[![Screenshot of EdgeQuake Frontend](https://github.com/raphaelmansuy/edgequake/raw/edgequake-main/docs/assets/01-screenshot.png)](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/assets/01-screenshot.png)
...
### 💉 Knowledge Injection ✨ NEW in 0.8.0 (#131)
...
### 🏷️ Custom Entity Configuration ✨ NEW in 0.9.0 (#85)
...
- **Custom Types**: Add any UPPERCASE\_UNDERSCORED entity type beyond the preset (e.g. `BEARING_TYPE`, `VIBRATION_ANOMALY`)
...
See [mcp/](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/mcp) for server implementation details.
...
See [LightRAG Algorithm Deep Dive](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/lightrag-algorithm.md) for the complete technical explanation.
...
Explore the full documentation at [docs/README.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/README.md)

### 📦 SDKs

EdgeQuake provides official SDKs for multiple languages:

- [Python SDK](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks/python/README.md) ([Changelog](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks/python/CHANGELOG.md))
- [TypeScript SDK](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks/typescript/README.md) ([Changelog](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks/typescript/CHANGELOG.md))
- [Rust SDK](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks/rust/README.md)
- [Other SDKs](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks) for C#, Go, Java, Kotlin, PHP, Ruby, Swift

See the [CHANGELOG.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/CHANGELOG.md) for SDK and core updates.

### 🚀 Getting Started (15 minutes)

| Guide | Description | Time |
| --- | --- | --- |
| [Installation](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/getting-started/installation.md) | Prerequisites and setup | 5 min |
| [Quick Start](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/getting-started/quick-start.md) | First ingestion and query | 10 min |
| [First Ingestion](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/getting-started/first-ingestion.md) | Understanding the pipeline | 15 min |

### 📖 Tutorials (Hands-On)

| Tutorial | Description |
| --- | --- |
| [Building Your First RAG App](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/tutorials/first-rag-app.md) | End-to-end tutorial |
| [PDF Ingestion](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/tutorials/pdf-ingestion.md) | PDF upload and configuration |
| [Multi-Tenant Setup](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/tutorials/multi-tenant.md) | Workspace isolation |
| [Document Ingestion](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/tutorials/document-ingestion.md) | Upload and processing workflows |
| [Migration from LightRAG](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/tutorials/migration-from-lightrag.md) | Python to Rust migration guide |

### 🏗️ Architecture (How It Works)

| Document | Description |
| --- | --- |
| [Overview](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/architecture/overview.md) | System design and components |
| [Data Flow](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/architecture/data-flow.md) | How documents flow through the system |
| [Crate Reference](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/architecture/crates) | 11 Rust crates explained |

### 💡 Core Concepts (Theory)

| Concept | Description |
| --- | --- |
| [Graph-RAG](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/concepts/graph-rag.md) | Why knowledge graphs enhance RAG |
| [Entity Extraction](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/concepts/entity-extraction.md) | LLM-based entity recognition |
| [Knowledge Graph](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/concepts/knowledge-graph.md) | Nodes, edges, and communities |
| [Hybrid Retrieval](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/concepts/hybrid-retrieval.md) | Combining vector and graph search |

### Deep Dives (Advanced)

| Article | Description |
| --- | --- |
| [LightRAG Algorithm](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/lightrag-algorithm.md) | Core algorithm: extraction, graph, retrieval |
| [Query Modes](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/query-modes.md) | 6 modes explained with trade-offs |
| [Entity Normalization](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/entity-normalization.md) | Deduplication and description merging |
| [Gleaning](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/gleaning.md) | Multi-pass extraction for completeness |
| [Community Detection](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/community-detection.md) | Louvain clustering for global queries |
| [Chunking Strategies](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/chunking-strategies.md) | Token-based segmentation with overlap |
| [Embedding Models](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/embedding-models.md) | Model selection and dimension trade-offs |
| [Graph Storage](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/graph-storage.md) | Apache AGE property graph backend |
| [Vector Storage](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/vector-storage.md) | pgvector HNSW indexing and search |
| [PDF Processing](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/pdf-processing.md) | Text/Vision/Hybrid extraction pipeline |
| [Cost Tracking](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/cost-tracking.md) | LLM cost monitoring per operation |
| [Pipeline Progress](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/deep-dives/pipeline-progress.md) | Real-time progress tracking |

### 📊 Comparisons

| Comparison | Key Insights |
| --- | --- |
| [vs LightRAG (Python)](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/comparisons/vs-lightrag-python.md) | Performance and design differences |
| [vs GraphRAG](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/comparisons/vs-graphrag.md) | Microsoft's approach comparison |
| [vs Traditional RAG](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/comparisons/vs-traditional-rag.md) | Why graphs matter |

### API Reference

| API | Description |
| --- | --- |
| [REST API](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/api-reference/rest-api.md) | HTTP endpoints |
| [Extended API](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/api-reference/extended-api.md) | Advanced API features |

### Operations (Production)

| Guide | Description |
| --- | --- |
| [Deployment](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/operations/deployment.md) | Production deployment |
| [Configuration](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/operations/configuration.md) | All config options |
| [Monitoring](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/operations/monitoring.md) | Observability setup |
| [Performance Tuning](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/operations/performance-tuning.md) | Optimization guide |

### 🐛 Troubleshooting

| Guide | Description |
| --- | --- |
| [Common Issues](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/troubleshooting/common-issues.md) | Debugging guide |
| [PDF Extraction](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/troubleshooting/pdf-extraction.md) | PDF-specific troubleshooting |

### 🔗 Integrations

| Integration | Description |
| --- | --- |
| [MCP Server](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/mcp) | Model Context Protocol for AI agents |
| [OpenWebUI](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/integrations/open-webui.md) | Chat interface with Ollama emulation |
| [LangChain](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/integrations/langchain.md) | Retriever and agent integration |
| [Custom Clients](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/integrations/custom-clients.md) | Python, TypeScript, Rust, Go clients |

### 📓 More Resources

- [FAQ](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/faq.md) - Frequently asked questions
- [Cookbook](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/cookbook.md) - Practical recipes
- [Security](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/security) - Security best practices
...
See [AGENTS.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/AGENTS.md) for detailed agent workflow documentation.
...
See [CONTRIBUTING.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/CONTRIBUTING.md) for detailed contribution guidelines.
...
We are committed to providing a welcoming and inclusive environment. Please read our [Code of Conduct](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/CODE_OF_CONDUCT.md).
...
Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the [LICENSE](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/LICENSE) file for the specific language governing permissions and limitations.
...
| Resource | URL |
| --- | --- |
| 📚 Full Documentation | [docs/README.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/README.md) |
| 🚀 Quick Start Guide | [docs/getting-started/quick-start.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/getting-started/quick-start.md) |
| 📦 SDKs Overview | [sdks/](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks) |
| 🐍 Python SDK | [sdks/python/README.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks/python/README.md) |
| 🦀 Rust SDK | [sdks/rust/README.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks/rust/README.md) |
| 🟦 TypeScript SDK | [sdks/typescript/README.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/sdks/typescript/README.md) |
| 📜 CHANGELOG | [CHANGELOG.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/CHANGELOG.md) |
| 🔧 Agent Workflow | [AGENTS.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/AGENTS.md) |
| 🤝 Contributing | [CONTRIBUTING.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/CONTRIBUTING.md) |
| 📜 Code of Conduct | [CODE\_OF\_CONDUCT.md](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/CODE_OF_CONDUCT.md) |
| 📄 License | [LICENSE](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/LICENSE) |
...
**Ready to build intelligent document retrieval?** [Get started now!](https://github.com/raphaelmansuy/edgequake/blob/edgequake-main/docs/getting-started/quick-start.md)

[![Star History Chart](https://camo.githubusercontent.com/c08cef00a1c6e8930e6c96aafced62b193c901684fab2068c91687cfecf350d4/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f7376673f7265706f733d7261706861656c6d616e7375792f656467657175616b6526747970653d64617465266c6567656e643d746f702d6c656674)](https://www.star-history.com/#raphaelmansuy/edgequake&type=date&legend=top-left)