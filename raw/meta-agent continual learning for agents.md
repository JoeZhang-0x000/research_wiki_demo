...
source: "https://x.com/essamsleiman/status/2041224799746428944"
author:
  - "[[@essamsleiman]]"
published: 2026-04-07
created: 2026-04-07
description: "We built meta-agent: an open-source library that automatically and continuously improves agent harnesses from production traces.Point it at ..."
tags:
  - "clippings"
---
...
2. A proposer reads failed traces and writes one targeted harness update at a time, such as changes to prompts, hooks, tools, or subagents.
3. The update is kept only if it improves holdout accuracy.
...
![Image](https://pbs.twimg.com/media/HFOIz7naQAAlt6A?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HFPS2o8boAAKwRU?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HFPDd3LbUAAXQhU?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HFPUrd4aIAAtxJR?format=png&name=large)
