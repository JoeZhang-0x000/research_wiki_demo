---
title: "MetaX-MACA/vLLM-metax: Community maintained hardware plugin for vLLM on MetaX GPU"
source: "https://github.com/MetaX-MACA/vLLM-metax"
author:
published:
created: 2026-04-07
description: "Community maintained hardware plugin for vLLM on MetaX GPU - MetaX-MACA/vLLM-metax"
tags:
  - "clippings"
---
![vLLM](https://raw.githubusercontent.com/vllm-project/vllm/main/docs/assets/logos/vllm-logo-text-dark.png)

### vLLM MetaX Plugin

| [**About MetaX**](https://www.metax-tech.com/en/) | [**Documentation**](https://vllm-metax.readthedocs.io/en/latest/) | [**#sig-maca**](https://slack.vllm.ai/) |
...
vLLM MetaX is a hardware plugin for running vLLM seamlessly on MetaX GPU, which is a cuda\_alike backend and provided near-native CUDA experiences on MetaX Hardware with [*MACA*](https://www.metax-tech.com/en/goods/platform.html?cid=4).
